...
hi Search       ctermfg=black ctermbg=yellow cterm=NONE      term=UNDERLINE
hi IncSearch    ctermfg=black ctermbg=gray   cterm=UNDERLINE

hi ZenkakuSpace term=UNDERLINE ctermfg=DarkGray cterm=UNDERLINE

" GVim {{{2
hi Normal       guifg=black guibg=gray88
hi Cursor                   guibg=LimeGreen
hi CursorIM                 guibg=IndianRed4
hi CursorLine   guifg=NONE  guibg=gray80

hi Title        guifg=DarkBlue guibg=NONE   gui=NONE

hi Number       guifg=ForestGreen gui=NONE
hi Statement    guifg=brown       gui=NONE
hi SpecialKey   guifg=gray68
hi StatusLine   guifg=blue        guibg=gray60 gui=NONE
hi StatusLineNC guifg=black       guibg=gray60 gui=NONE
hi ErrorMsg     guifg=red         guibg=NONE   gui=NONE

hi Search       guifg=black guibg=khaki gui=NONE
hi IncSearch    guifg=black guibg=pink  gui=UNDERLINE

hi Folded       guifg=gray50 guibg=NONE gui=NONE
hi FoldColumn   guifg=black  guibg=NONE gui=NONE

hi ZenkakuSpace guifg=gray80 gui=UNDERLINE

hi VimError        guifg=#9e3224 guibg=NONE gui=bold
hi VimCommentTitle guifg=#5a7471

hi qfFileName      guifg=LightBlue4 guibg=NONE
hi qfLineNr        guifg=brown      guibg=NONE
